    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-4 z-50" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
            <div className="bg-[#FBFFF5] rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                {/* Content */}
                <form onSubmit={handleSubmit} className="py-3 px-5 space-y-6">
                    {/* Upload Section */}
                    <div className="border-3 border-dashed border-[#B5B5B4] rounded-2xl p-8 text-center hover:border-green-500 transition-colors">
